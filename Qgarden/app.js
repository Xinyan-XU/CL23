    ...
    button.addEventListener('click', function () {
        ...
        fetch(API_URL)
            ...
            .catch(error => {
                ...
                showError("!!!Try again!!! Tips: Use a hyphen (-) for spaces. Type all lower cases. Try defining plants more specifically. For example, use \"Cucumber-Heirloom-Straight-Eight\" 🥹 instead of just \"cucumber\". Also, try searching for flowers, fruits, and more!");
            });
    })
